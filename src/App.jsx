    ...
    <ThemeProvider>
      <LanguageProvider>
        <Router>
          ...
          {/* GLOBAL FIX: pt-32 (128px) guarantees the sticky h-24 navbar
              never covers H1 or paragraph text on any page. */}
          <main className="page-container pt-32 min-h-[calc(100vh-8rem)]">
            <Routes>
